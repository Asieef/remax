<template>
    <div class="container mx-auto py-20 font-display">
                    ...
                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                        <form method="post" @submit.prevent="sendMail">
                            ...
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">
                                    <button
                                        class="flex mx-auto text-white bg-[#FDD000] border-0 py-2 px-8 focus:outline-none hover:bg-gray-700 rounded text-lg"
                                    >Send</button>
                                </div>
                                <div
                                    id="alert-1"
                                ...
                                >
                                    <p class="leading-normal my-5">
                                        ...
                                        <br />Laboratory Road Dhaka-1205, Bangladesh
                                        <br />Tel: +880 2 9612629-30 .
                                    </p>
                                </div>
                            </div>
                        </form>
