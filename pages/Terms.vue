<template>
    <div class="py-12 px-10 container mx-auto font-display">
        ...
        <h2 class="mt-10">This Privacy Policy describes how your personal information is collected, used, and shared
            when you visit or make a purchase from remax.com.bd</h2>
        <br />
        <br />
        ...
        <p>
            ...
            above. We use Google Analytics to help us understand how our customers use the Site — you can read more
            about how Google uses your Personal Information here: https://www.google.com/intl/en/policies/privacy/. You
        ...
        <p>
            ...
            complaint, please contact us by e mail at (info@remax.com.bd)</p>
        </p>
    </div>
</template>
