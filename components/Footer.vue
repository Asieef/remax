<template>
    <div class="grid grid-flow-row font-display pt-8">
                ...
                <ul>
                    ...
                    <div class="col-span-4 lg:flex items-center">
                        <form method="post" @submit.prevent="sendMail">
                            <input v-model="honeyPot" type="checkbox" style="display:none" name="honeyPot" tabindex="-1"
                                autocomplete="off" />
        ...
        <div id="alert-1" class="flex w-full p-4 mb-4 bg-blue-100 rounded-lg dark:bg-blue-200" role="alert"
            v-if="showThanks">
            ...
            <div class="ml-3 text-sm font-medium text-blue-700 dark:text-blue-800">Your Email Address has been submitted
            </div>
            <button @click="toggleThanks" type="button"
        ...
        <div class="p-8 grid lg:grid-flow-col lg:grid-cols-2 grid-cols-1 border-t border-white bg-[#1B1F23]">
